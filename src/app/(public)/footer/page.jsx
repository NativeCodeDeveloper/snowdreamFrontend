...
export default function App() {
  ...
  return (
    <footer
      id="footer"
      className="text-white-700 bg-white border-t border-gray-200 tracking-[0.01em]"
    >
      {/* REDES SOCIALES */}
      ...
      <section className="w-full">
        <div className="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-[1fr_auto] items-center gap-4">
          <div>
            <h3 className="text-white-900 text-lg font-semibold">Consulta por tu Joya Favorita</h3>
            <p className="text-white-900 text600 text-sm mt-1">
              Consulta sobre tus despachos, nos aseguramos de que tu pedido llegue a tus manos.
            </p>
          </div>

          <p className="text-white-500 text-xs md:col-span-2">
            Síguenos en redes sociales y no te pierdas nuestras promociones y concursos.{' '}
            <a href="#" className="no-underline text-white-700 hover:text-gray-900">Ir a redes</a>.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto text-center md:text-left mt-8 px-4">
          <div className="mt-2 md:mt-3 grid gap-8 md:gap-6 md:grid-cols-12">
            ...
            <div className="md:col-span-5 lg:col-span-5 xl:col-span-4">
              <h6 className="text-white-900 uppercase tracking-wide text-sm font-semibold mb-4 flex items-center gap-2">
                <svg viewBox="0 0 24 24" className="h-4 w-4 text-white-700" fill="currentColor" aria-hidden="true"><path d="M12 2l2.39 4.84L20 8l-4 3.9L17 18l-5-2.64L7 18l1-6.1L4 8l5.61-1.16L12 2z"/></svg>
                Runa Joyas
              </h6>
              <p className="text-white-600 leading-relaxed text-sm">
            ...
            <div className="hidden lg:block md:col-span-3 lg:col-span-3 xl:col-span-2">
              <h6 className="text-white-900 uppercase tracking-wide text-sm font-semibold mb-4">Productos</h6>
            ...
            <div className="hidden lg:block md:col-span-3 lg:col-span-3 xl:col-span-2">
              <h6 className="text-white-900 uppercase tracking-wide text-sm font-semibold mb-4">Enlaces</h6>
              <ul className="space-y-2 text-sm text-white-600">
                <li>Categorías</li>
                <li>Más vendidos</li>
                <li>Ofertas</li>
            ...
            <div className="md:col-span-4 lg:col-span-4 xl:col-span-4">
              <h6 className="text-white-900 tracking-wide uppercase text-sm font-bold mb-3 md:mb-4">Contacto</h6>
              <ul className="space-y-2 text-xs sm:text-sm text-white-600">
                ...
                <li className="flex items-start gap-2"><svg className="h-4 w-4 mt-0.5" viewBox="0 0 24 24" fill="currentColor"><path d="M6.62 10.79a15.53 15.53 0 0 0 6.59 6.59l2.2-2.2a1 1 0 0 1 1.05-.24c1.15.38 2.39.59 3.54.59a1 1 0 0 1 1 1v3.5a1 1 0 0 1-1 1A17.5 17.5 0 0 1 2.5 6a1 1 0 0 1 1-1H7a1 1 0 0 1 1 1c0 1.15.2 2.39.59 3.54a1 1 0 0 1-.24 1.05l-2.2 2.2z"/></svg>
                  <a href="tel:+56968343380" className="no-underline text-white-600 hover:text-white-900">+56 9 6834 3380</a></li>
        ...
        <div className="max-w-6xl mx-auto px-4 py-6 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
          <div className="flex flex-col items-center justify-center gap-3">
            <div className="flex items-center justify-center gap-3">
              <svg className="h-5 w-5 text-white-700" viewBox="0 0 24 24" fill="currentColor"><path d="M3 6h18v2H3V6zm2 4h14l-1.5 8h-11L5 10zm4 9h6v2H9v-2z"/></svg>
              <div className="text-left">
                <p className="text-sm font-semibold text-white-900 m-0">Despacho a todo Chile</p>
                <p className="text-xs text-white-600 m-0">Envíos seguros y confiables</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-center gap-3">
            <svg className="h-5 w-5 text-white-700" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a5 5 0 0 1 5 5v3h-2V7a3 3 0 1 0-6 0v3H7V7a5 5 0 0 1 5-5zm-7 9h14v11H5V11zm7 3a3 3 0 1 1 0 6 3 3 0 0 1 0-6z"/></svg>
            <div className="text-left">
              <p className="text-sm font-semibold text-white-900 m-0">Compra Segura</p>
              <p className="text-xs text-white-600 m-0">Pagos cifrados</p>
              <div className="flex items-center gap-2 mt-2">
                <span className="text-white-600 text-xs">Pagos con</span>
          ...
          <div className="flex items-center justify-center gap-3">
            <svg className="h-5 w-5 text-white-700" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20zm-3 11h6v2H9v-2zm0-4h6v2H9V9z"/></svg>
            <div className="text-left">
              <p className="text-sm font-semibold text-white-900 m-0">Múltiples métodos de pago</p>
              <p className="text-xs text-white-600 m-0">Crédito, débito y transferencias</p>
              <div className="flex items-center gap-2 mt-2">
